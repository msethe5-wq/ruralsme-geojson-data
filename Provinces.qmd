...
<qgis version="3.44.8-Solothurn">
  <identifier>Province_New_SANeighbours</identifier>
  <parentidentifier></parentidentifier>
  <language>EN</language>
  <type>dataset</type>
  <title>Province_New_SANeighbours</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link mimeType="" name="Shapefile" format="" description="" size="" type="Local Area Network" url="file://\\VOSTRO_X\C$\Data\Shapefiles\Province_New_SANeighbours.shp"/>
  </links>
  <dates/>
  <fees></fees>
